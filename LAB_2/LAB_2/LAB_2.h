...
Заголовочный файл проекта LAB_2
Михайлов Роман, группа 3091, 1 курс
28.02.2024 - 07.03.2024
...
namespace LAB_2 {
	...
	/// Сводка для MyForm
	/// </summary>
	public ref class LAB_2 : public System::Windows::Forms::Form
	{
	public:
		LAB_2(void)
		{
	...
	private: short int count = 0;			// Целочисленная переменная, в которой хранится количество элементов в введенном массиве
	private: time_t start, end;				// Переменны, в коротых хранится время начала и конца выполнения сортировки
	private: bool is_word = true;			// Булевая переменная, которая фиксирует способ ввода массива символов (словом или через запятую)
	private: short int chosen_mode = -1;	// Целочисленная переменная, в коротой хранится индекс выбранного варианта ввода массива
	private: short int pr_mode = -1;		// Целочисленная переменная, которая хранит номер предыдущего варианта массива
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox1->Items->AddRange(gcnew cli::array< System::Object^  >(5) {
				L"Поразрядная", L"Вставками", L"Пузырьковая", L"Шейкерная",
					L"Быстрая"
			});
			this->comboBox1->Location = System::Drawing::Point(267, 55);
			...
			// input_textBox
			// 
			this->input_textBox->Location = System::Drawing::Point(19, 125);
			...
			this->input_textBox->Size = System::Drawing::Size(582, 195);
			this->input_textBox->TabIndex = 0;
			this->input_textBox->TextChanged += gcnew System::EventHandler(this, &LAB_2::input_textBox_TextChanged);
			// 
			// output_textBox
			// 
			this->output_textBox->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->output_textBox->Location = System::Drawing::Point(19, 358);
			this->output_textBox->Multiline = true;
			this->output_textBox->Name = L"output_textBox";
			this->output_textBox->ScrollBars = System::Windows::Forms::ScrollBars::Vertical;
			this->output_textBox->Size = System::Drawing::Size(584, 195);
			this->output_textBox->TabIndex = 1;
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(516, 30);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(94, 60);
			this->button1->TabIndex = 2;
			this->button1->Text = L"Запуск";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &LAB_2::run_btn_Click);
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->Location = System::Drawing::Point(13, 559);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(251, 20);
			this->label1->TabIndex = 4;
			this->label1->Text = L"Время выполнения сортировки:";
			// 
			// time_label
			// 
			this->time_label->AutoSize = true;
			this->time_label->Location = System::Drawing::Point(266, 560);
			this->time_label->Name = L"time_label";
			this->time_label->Size = System::Drawing::Size(0, 20);
			...
			this->comboBox2->Items->AddRange(gcnew cli::array< System::Object^  >(6) {
				L"Ввод массива целых чисел", L"Ввод массива символов",
					L"Тестовый массив №1", L"Тестовый массив №2", L"Тестовый массив №3", L"Создание случайного массива"
			});
			this->comboBox2->Location = System::Drawing::Point(19, 55);
			this->comboBox2->Name = L"comboBox2";
			this->comboBox2->Size = System::Drawing::Size(237, 28);
			this->comboBox2->TabIndex = 6;
			this->comboBox2->SelectedIndexChanged += gcnew System::EventHandler(this, &LAB_2::comboBox2_SelectedIndexChanged);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(17, 589);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(139, 34);
			this->button2->TabIndex = 7;
			this->button2->Text = L"Очистить поля";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &LAB_2::clear_btn_Click);
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(173, 589);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(139, 34);
			this->button3->TabIndex = 8;
			this->button3->Text = L"Информация";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &LAB_2::info_btn_Click);
			// 
			// button4
			// 
			this->button4->Location = System::Drawing::Point(490, 589);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(111, 34);
			this->button4->TabIndex = 9;
			this->button4->Text = L"Тест";
			this->button4->UseVisualStyleBackColor = true;
			this->button4->Click += gcnew System::EventHandler(this, &LAB_2::button4_Click);
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(263, 25);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(243, 20);
			this->label2->TabIndex = 10;
			this->label2->Text = L"Алгоритм сортировки массива";
			// 
			// label3
			// 
			...
			this->label3->Text = L"Тип вводимого массива";
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(19, 98);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(100, 20);
			this->label4->TabIndex = 12;
			this->label4->Text = L"Поле ввода";
			// 
			// label5
			// 
			this->label5->AutoSize = true;
			this->label5->Location = System::Drawing::Point(19, 332);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(111, 20);
			this->label5->TabIndex = 13;
			this->label5->Text = L"Поле вывода";
			// 
			// LAB_2
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(9, 20);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(622, 641);
			...
			this->Text = L"Лабораторная работа №2. Сортировки";
...
#pragma endregion
	...
	private: void correct_input()
	{
		...
		while (j < data->Length)
		{
			if (!(data[j] >= '0' && data[j] <= '9') && !(data[j] == ',' || data[j] == ' ') && (chosen_mode == 0 || chosen_mode > 1))
			{
				if (flag == 0) flag = 1;
				if (flag && flag2)
				{
				...
				this->input_textBox->Text = this->input_textBox->Text->Remove(j, 1);
			}
			j++;
		}
	}
	//
	// Процедура, ограничивающая ввод двойного пробела или двойной запятой, и ввод первым элементом пробела или запятую
	//
	private: void incorrect_input()
	{
		...
		for (j = 0; j < data->Length; j++)
		{
			if (data[0] == ',' || data[0] == ' ')
			{
				this->input_textBox->Text = this->input_textBox->Text->Remove(0, 1);
			}
			else if (data->Contains(",,"))
			{
				this->input_textBox->Text = this->input_textBox->Text->Replace(",,", ",");
			}
			else if (data->Contains("  "))
			{
				this->input_textBox->Text = this->input_textBox->Text->Replace("  ", " ");
			...
			else if ((data->Length > 1) && (j < data->Length - 1) && (data[j + 1] == ' ' && data[j + 1] != ',') && (data[j] >= '0' && data[j] <= '9'))
			{
				this->input_textBox->Text = this->input_textBox->Text->Remove(j + 1, 1) + ",";
			}
		}
	}
	//
	// Процедура ограничения максимально возможного значения
	//
	private: void max_value_input()
	{
		int j = 0, i = 0;
		int max_value = 200000000;
		String^ data = this->input_textBox->Text;
		String^ temp;
		cli::array<int>^ a = gcnew cli::array<int>(2500);
		while (j < data->Length)
		{
			if (j == data->Length - 1)
			{
				...
				if (System::Convert::ToInt32(temp) > max_value)
				{
					MessageBox::Show("Некорректный ввод", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
					this->input_textBox->Text = this->input_textBox->Text->Remove(j, 1);
				}
	...
	//
	// Процедура, ограничивающая максимальное количество введенных элементов
	//
	private: void max_quantity()
	{
		int i = 0;
		String^ data = this->input_textBox->Text;
		if (!data->Contains(", "))
		{
			...
			if (data->Length > 2500)
			{
				MessageBox::Show("Достигнуто максимальное количество введенных элементов", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
				this->input_textBox->Text = this->input_textBox->Text->Remove(data->Length - 1, 1);
			}
		}
		else
		{
	...
	//
	// Процедура проверка ввода
	//
	private: void input_check()
	{
		if (this->comboBox2->SelectedIndex == -1 && this->input_textBox->Text != "")
		{
			MessageBox::Show("Выбирете тип вводимого массива", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
	...
	// Вход void
	// Выход cli::array<int>^ массив из 2500 элементов
	//
	private: cli::array<UInt32>^ int_input_array()
	{
		count = 0;
		cli::array<UInt32>^ arr = gcnew cli::array<UInt32>(2500);
		String^ data = this->input_textBox->Text;
		String^ temp;
		int j = 0, i = 0;
		while (j < data->Length)
		{
			...
			{
				temp += data[j];
				arr[i] = System::Convert::ToInt32(temp);
				count++;
				return arr;
			}
			else if (data[j + 1] != ' ' && data[j] != ',')
	...
	//
	// Функция ввода массива символов
	// Вход void
	// Выход cli::array<int>^ массив из 2500 элементов
	//
	private: cli::array<UInt32>^ char_input_array()
	{
		count = 0;
		cli::array<UInt32>^ arr = gcnew cli::array<UInt32>(2500);
		String^ data = this->input_textBox->Text;
		...
		if (data->Contains(", "))
		{
			...
			while (j < data->Length)
			{
				...
				{
					temp = System::Convert::ToInt32(data[j]);
				}
				else
				{
					arr[i] = temp;
	...
	// Вход массив (cli::array<int>^), количество элементов (int)
	// Выход массив (cli::array<int>^)
	//
	private: cli::array<UInt32>^ shaker_sort(cli::array<UInt32>^ a, int quantity)
	{
		start = clock();
	...
	// Выход массив (cli::array<int>^)
	//
	private: cli::array<UInt32>^ insertion_sort(cli::array<UInt32>^ a, int quantity)
	{
		start = clock();
	...
	// Выход массив (cli::array<int>^)
	//
	private: cli::array<UInt32>^ bubble_sort(cli::array<UInt32>^ a, int quantity)
	{
		start = clock();
	...
	//
	private: void quick_sort(cli::array<UInt32>^ arr, int start, int end)
	{
		int l = start;
		int r = end;
		int piv = arr[(l + r) / 2];
	...
	//
	// Функция инициализации быстрой сортировки
	// Вход массив (cli::array<int>^), количество элементов (int)
	// Выход массив (cli::array<int>^)
	//
	private: cli::array<UInt32>^ quick_sort_init(cli::array<UInt32>^ a, int quantity)
	{
		start = clock();
		quick_sort(a, 0, quantity - 1);
		end = clock();
		return a;
	}
	//
	...
	// Вход массив (cli::array<int>^), количество элементов (int)
	// Выход миксимальное число (unsigned int)
	//
	private: unsigned int max_value(cli::array<UInt32>^ a, int quantity)
	{
	...
	// Выход массив (cli::array<int>^)
	//
	private: cli::array<UInt32>^ radix_sort(cli::array<UInt32>^ a, int quantity)
	{
		start = clock();
		unsigned int exp, i;
		...
		{
			int i, count[10] = { 0 };
			cli::array<int>^ result = gcnew cli::array<int>(quantity);
	...
	//
	// Фунция перевода массива целых чисел в строку
	// Вход массив (cli::array<int>^), количество элементов (int)
	// Выход массив в виде строки (String^)
	//
	private: String^ int_array_to_string(cli::array<UInt32>^ a, int quantity)
	{
		String^ str_arr;
		for (int i = 0; i < quantity; i++)
		{
			if (i < quantity - 1)
			{
				str_arr += System::Convert::ToString(a[i]) + ", ";
			}
			else
			{
				str_arr += System::Convert::ToString(a[i]);
	...
	// Выход массив в виде строки (String^)
	//
	private: String^ char_array_to_string(cli::array<UInt32>^ a, int quantity)
	{
		String^ str_arr;
		if (is_word)
		{
			for (int i = 0; i < quantity; i++)
			{
				str_arr += Convert::ToString(Convert::ToChar(a[i]));
			}
		}
		else
		{
	...
	{
		if (this->input_textBox->Text->Contains("Введите размер случайного массива: ") && this->input_textBox->Text->Contains(";") && chosen_mode == 5)
		{
			String^ data = (this->input_textBox->Text->Replace("Введите размер случайного массива: ", ""))->Replace(";", "");
			if (data != "")
			{
				int random_array_length = System::Convert::ToInt32((data->Replace("Введите размер случайного массива: ", ""))->Replace(";", ""));
				if (random_array_length > 2500)
				{
					String^ temp = System::Convert::ToString(random_array_length);
					MessageBox::Show("Слишком большое количество элементов. Максимальное количество - 2500", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
					this->input_textBox->Text = this->input_textBox->Text->Remove(this->input_textBox->Text->Length - 1, 1);
					this->input_textBox->Text = this->input_textBox->Text->Replace(temp, "2500");
				}
				else
				{
					this->input_textBox->Text = "";
					...
					{
						if (i == random_array_length - 1)
							temp += System::Convert::ToString(rand());
						else
							temp += System::Convert::ToString(rand()) + ", ";
					}
					this->input_textBox->Text = temp;
	...
	private: void run_func()
	{
		...
		{
			if (this->comboBox2->SelectedIndex == 0 || (this->comboBox2->SelectedIndex > 1 && this->comboBox2->SelectedIndex < 5))
			{
				switch (this->comboBox1->SelectedIndex)
				{
				case 0: this->output_textBox->Text = int_array_to_string(radix_sort(int_input_array(), count), count); break;
				case 1: this->output_textBox->Text = int_array_to_string(insertion_sort(int_input_array(), count), count); break;
				case 2: this->output_textBox->Text = int_array_to_string(bubble_sort(int_input_array(), count), count); break;
				case 3: this->output_textBox->Text = int_array_to_string(shaker_sort(int_input_array(), count), count); break;
				case 4: this->output_textBox->Text = int_array_to_string(quick_sort_init(int_input_array(), count), count); break;
				}
			}
			else if (this->comboBox2->SelectedIndex == 1)
			{
				switch (this->comboBox1->SelectedIndex)
				{
				case 0: this->output_textBox->Text = char_array_to_string(radix_sort(char_input_array(), count), count); break;
				case 1: this->output_textBox->Text = char_array_to_string(insertion_sort(char_input_array(), count), count); break;
				case 2: this->output_textBox->Text = char_array_to_string(bubble_sort(char_input_array(), count), count); break;
				case 3: this->output_textBox->Text = char_array_to_string(shaker_sort(char_input_array(), count), count); break;
				case 4: this->output_textBox->Text = char_array_to_string(quick_sort_init(char_input_array(), count), count); break;
				}
			}
		}

		if (this->output_textBox->Text != "")
		{
			double sort_time = (double)(end - start) / CLOCKS_PER_SEC;
			this->time_label->Text = System::Convert::ToString(sort_time) + " секунд";
		}
	}
	//
	// Процедура, описывающая действия при нажатии кнопки "Запуск"
	//
	private: System::Void run_btn_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		if (data->EndsWith(", "))
		{
			this->input_textBox->Text = data->Remove(data->Length - 2, 2);
		}
		else if (data->EndsWith(",") || data->EndsWith(" "))
		{
			this->input_textBox->Text = data->Remove(data->Length - 1, 1);
		}

		int res = not_choosen_mode_check() + not_choosen_variant_check() + empty_check();
		if (!res)
		{
			run_func();
			pr_mode = -1;
	...
	//
	// Процедура проверки корректности ввода размера случайного массива
	//
	private: void random_input_check()
	{
		if (this->input_textBox->Text->Contains(";") && !(this->input_textBox->Text->EndsWith(";")))
		{
			this->input_textBox->Text = this->input_textBox->Text->Replace(";", "");
		}

		if (this->input_textBox->Text->Contains("Введите размер случайного массива: "))
		{
			String^ data = this->input_textBox->Text->Replace("Введите размер случайного массива: ", "");
			{
				for (int j = 0; j < data->Length; j++)
				{
	...
	//
	// Процедура, описывающая действия при изменении входных данных
	//
	private: System::Void input_textBox_TextChanged(System::Object^ sender, System::EventArgs^ e) 
	{
		if (chosen_mode == 5)
		{
			this->input_textBox->ReadOnly = false;
			random_input_check();
			random_array();
		}
		input_check();
	...
	private: System::Void comboBox2_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e)
	{
			...
			{
			case 2: this->input_textBox->Text = arr_1_1 + arr_1_2 + arr_1_3 + arr_1_4 + arr_1_5; break;
			case 3: this->input_textBox->Text = arr_2_1 + arr_2_2 + arr_2_3; break;
			case 4: this->input_textBox->Text = arr_3_1 + arr_3_2 + arr_3_3 + arr_3_4 + arr_3_5; break;
			}

			chosen_mode = this->comboBox2->SelectedIndex;
			if (chosen_mode == 0)
			{
				input_check();
				this->input_textBox->ReadOnly = false;
			}
			else if (chosen_mode > 1 && chosen_mode < 5)
			{
				this->input_textBox->ReadOnly = true;
			}
			else if (chosen_mode == 5)
			{
				pr_mode = 5;
				this->input_textBox->Text = "Введите размер случайного массива: ";
			}
	}
	//
	// Процедура, описывающая действия при нажатии кнопки "Очистить поля"
	//
	private: System::Void clear_btn_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		if (double_clear_click_check())
		{
			this->input_textBox->Text = "";
	...
	//
	// Процедура, описывающая действия при нажатии кнопки "Информация"
	//
	private: System::Void info_btn_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		MessageBox::Show("Для работы с программой:\r\n\r\n1. Выберите тип вводимого массива\r\n\r\n2. Введите массив в поле ввода через запятую с пробелом (пример \",_\" _ - знак пробела), в конце запятую и знак пробела ставить не нужно\r\n\r\n3. Выберите алгоритм для сортировки в выпадающем списке\r\n\r\n4. Нажмите кнопку \"Запуск\"\r\n\r\nВ специальных полях будет выведено время выполнения сортирововк и полученный отсортированный массив\r\n\r\nДля повтороной работы с программой нажмине кнопку \"Очистить поля\".\r\n\r\nДля ввода тестового массива выберите в выпадающем списке \"Тип вводимого массива\" вариант заготовленного массива и нажмите кнопку \"Запуск\"\r\n\r\nДля ввода случайного массива в выпадающем списке выберите \"Ввод случайного массива\", введите размер массива, завершите ввод символом \";\"", "Информация о работе программы", MessageBoxButtons::OK, MessageBoxIcon::Information);
	}
	//
	// Функция, проверяющая поле ввода на наполненность/пустоту
	// Вход void
	// Выход int
	//
	private: int empty_check()
	{
		if (this->input_textBox->Text == "")
		{
			MessageBox::Show("Введите массив", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
			return 1;
		}
		else
		{
	...
	//
	// Функция, предотвращающая двойное очищение полей, при уже пустных полях
	// Вход void
	// Выход bool
	//
	private: bool double_clear_click_check()
	{
		if (this->input_textBox->Text == "" && this->output_textBox->Text == "")
		{
			MessageBox::Show("Поля уже очищены", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
			return false;
		}
		else
		{
	...
	//
	// Функция, проверяющая, что алгоритм сортировки выбран
	// Вход void
	// Выход int
	//
	private: int not_choosen_variant_check()
	{
		if (this->comboBox1->SelectedIndex == -1)
		{
			MessageBox::Show("Не выбран вариант алгоритма сортировки", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
			return 1;
		}
		else
		{
	...
	//
	// Функция, проверяющая, что тип вводимого массива сортировки выбран
	// Вход void
	// Выход int
	//
	private: int not_choosen_mode_check()
	{
		if (this->comboBox2->SelectedIndex == -1)
		{
			MessageBox::Show("Не выбран вариант вводимого массива", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
			return 1;
		}
		else
		{
	...
	// Вход два массива (cli::array<int>^ )
	//
	private: bool compare_arrays(cli::array<UInt32>^ a, cli::array<UInt32>^ b)
	{
		for (int i = 0; i < 5; i++)
		{
			if (a[i] != b[i])
	...
	//
	// Функция тестирования поразрядной сортировки, входной массива {5, 4, 3, 2, 1}, ожидание {1, 2, 3, 4, 5}
	// Вход void
	// Выход int
	//
	private: int test_radix_sort()
	{
		cli::array<UInt32>^ test = {5, 4, 3, 2, 1};
		cli::array<UInt32>^ compare = { 1, 2, 3, 4, 5 };

		radix_sort(test, 5);
		if (compare_arrays(test, compare))
		{
			return 0;
		}
		else
	...
	//
	// Функция тестирования сортировки вставками, входной массива {5, 4, 3, 2, 1}, ожидание {1, 2, 3, 4, 5}
	// Вход void
	// Выход int
	//
	private: int test_insertion_sort()
	{
		cli::array<UInt32>^ test = { 5, 4, 3, 2, 1 };
		cli::array<UInt32>^ compare = { 1, 2, 3, 4, 5 };
	...
	//
	// Функция тестирования пузырьковой сортировки, входной массива {5, 4, 3, 2, 1}, ожидание {1, 2, 3, 4, 5}
	// Вход void
	// Выход int
	//
	private: int test_bubble_sort()
	{
		cli::array<UInt32>^ test = { 5, 4, 3, 2, 1 };
		cli::array<UInt32>^ compare = { 1, 2, 3, 4, 5 };
	...
	//
	// Функция тестирования шейкерной сортировки, входной массива {5, 4, 3, 2, 1}, ожидание {1, 2, 3, 4, 5}
	// Вход void
	// Выход int
	//
	private: int test_shaker_sort()
	{
		cli::array<UInt32>^ test = { 5, 4, 3, 2, 1 };
		cli::array<UInt32>^ compare = { 1, 2, 3, 4, 5 };
	...
	//
	// Функция тестирования быстрой сортировки, входной массива {5, 4, 3, 2, 1}, ожидание {1, 2, 3, 4, 5}
	// Вход void
	// Выход int
	//
	private: int test_quick_sort()
	{
		cli::array<UInt32>^ test = { 5, 4, 3, 2, 1 };
		cli::array<UInt32>^ compare = { 1, 2, 3, 4, 5 };
	...
	//
	// Процедура запуска тестирования
	//
	private: void test_cases()
	{
		int result = test_radix_sort() + test_insertion_sort() + test_bubble_sort() + test_shaker_sort() + test_quick_sort();
		if (result == 0)
		{
		...
		{
			MessageBox::Show("Тесты не пройдены, программа работает некорректно", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
			this->Close();
		}
	}
	//
	// Процедура, описывающая действия при нажатии кнопки "Тест"
	//
	...
	//
	// Процедура запуска тестирования при запуске приложения
	//
	private: void test_cases_constructor()
	{
		int test_flag = test_radix_sort() + test_insertion_sort() + test_bubble_sort() + test_shaker_sort() + test_quick_sort();
		if (test_flag != 0)
		{
			System::Windows::Forms::DialogResult result = MessageBox::Show("Тесты не пройдены. Программа работает не корректно. Работа программы будет остановлена.", "Ошибка", MessageBoxButtons::OK, MessageBoxIcon::Error);
